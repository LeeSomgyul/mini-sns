...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = -48466372L;
    ...
    public QPost(Class<? extends Post> type, PathMetadata metadata, PathInits inits) {
        ...
        this.author = inits.isInitialized("author") ? new com.example.backend.domain.user.entity.QUser(forProperty("author")) : null;
    }
