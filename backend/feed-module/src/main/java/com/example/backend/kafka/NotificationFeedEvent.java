...
public record NotificationFeedEvent(
    ...
    public static NotificationFeedEvent of(String type, Long receiverUserId, Long triggerUserId, Long targerPostId, LocalDateTime createdAt){
        return new NotificationFeedEvent(
          type, receiverUserId, triggerUserId, targerPostId, createdAt);
    }
}
